...
export EXPERIMENTAL_ENGINE_RUST_VERSION=true # set to true if you want to use the experimental Rust version of the Wren Engine
# Windows
SET OTHER_SERVICE_USING_DOCKER=true
SET EXPERIMENTAL_ENGINE_RUST_VERSION=true # set to true if you want to use the experimental Rust version of the Wren Engine
